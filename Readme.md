...
# Parsing + Configuration Script – LoraWAN - Rev. A

This **Parsing + Configuration** script is designed for the **LoraWAN** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LoraWAN Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LoraWAN** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
